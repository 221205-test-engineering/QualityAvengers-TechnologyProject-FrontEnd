Feature: Scheduling games
  ...
  Scenario: Time and Location
    ...
    Then Admin should be able to select one of the venue option
    ...
    Then Todays date current time should appear at date input form
    ...
    Then The corresponding year month should be selected at the date form
  ...
  Scenario: Teams
    ...
    Then Admin should be able to select of from the options
    When Admin clicks schedule button
    Then Appropriate alert should appear
    When Admin clicks back button
    Then Admin should be on the Admin page
